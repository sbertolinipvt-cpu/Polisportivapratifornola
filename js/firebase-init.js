/* ============================================================
   ...
   Configurazione completa: apiKey, authDomain, databaseURL,
   projectId, storageBucket, messagingSenderId, appId sono tutti
   impostati. Se in futuro cambiate progetto Firebase, aggiornate
   i valori qui sotto (li trovate in Console Firebase → Impostazioni
   progetto → Generale, e per databaseURL in cima alla pagina
   "Realtime Database").
   ============================================================ */
(function () {
  "use strict";
  ...
  if (!firebaseConfig.databaseURL || firebaseConfig.databaseURL.indexOf("INSERISCI_QUI") === 0) {
