...
null",
  ...
  if (!firebaseConfig.databaseURL || firebaseConfig.databaseURL.indexOf("INSERISCI_QUI") === 0) {
    document.addEventListener("DOMContentLoaded", function () {
      ...
      bar.textContent = "⚠ Configurazione Firebase incompleta: manca \"databaseURL\" in js/firebase-init.js — il sito funziona solo in lettura statica, il pannello admin è disattivato.";
